...
export default function ProductCard({ title, price, stock, image }: Products) {
  return (
    <div className=" shadow-md px-4 flex flex-col justify-center items-center">
      ...
      <div className="mr-auto mb-4 ml-4">
        ...
        <button className="bg-blue-500 rounded-md px-2 py-1 hover:bg-blue-600 active:bg-blue-800 transition">
          add to cart
        </button>
      </div>
    </div>
