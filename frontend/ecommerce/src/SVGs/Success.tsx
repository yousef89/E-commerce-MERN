...
export default function SuccessLogo(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      <g fill="none" fillRule="evenodd">
        <g fillRule="nonzero">
          <path
            ...
            fill={props.fill || "#17AB13"} // Green checkmark
          />
          <path
            ...
            fill={props.fill || "#4A4A4A"} // Grey circular background
          />
        </g>
      </g>
    </svg>
